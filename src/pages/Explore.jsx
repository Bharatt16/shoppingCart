...
const Explore = () => {
  ...
  return (
    <div className="sm:pt-40 pt-30 sm:px-6 px-4 flex flex-col">
      ...
      <div className="sm:fixed sm:block hidden top-25 left-6 h-[80vh] w-1/5 overflow-hidden hover:overflow-y-auto hide-scrollbar">
        ...
        <div className="category-2 flex flex-col gap-3 my-5">
          ...
          <ul className="text-white flex flex-col gap-3 ">
            ...
            <li>
              <div className="flex items-center hover:invert gap-3 ">
                <div className="bg-[#202020] h-10 w-10 p-[10px] hover:invert">
                  <svg className="invert" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19 26">
            ...
            <li>
              <div className="flex items-center hover:invert gap-3 ">
                <div className="bg-[#202020] h-10 w-10 p-[10px] hover:invert">
                  <svg className="invert" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 16">
              ...
              <div className="flex items-center hover:invert gap-3 ">
                <div className="bg-[#202020] h-10 w-10 p-[10px] hover:invert">
                  <svg className="invert" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16">
                    <path d="M0 13.772l6.545.902V8.426H0zM0 7.62h6.545V1.296L0 2.198zm7.265 7.15l8.704 1.2V8.425H7.265zm0-13.57v6.42h8.704V0z"></path>
                  </svg>
                </div>
                PC
              </div>
...
>
      ...
      {/* 🎮 Games Section */}
      <div className="sm:ml-[22%] sm:w-[78%] min-h-screen overflow-y-auto p-6 border-1 border-red-500 flex flex-wrap">
        {games.length > 0 ? (
          games.map((game) => (
            <div
              key={game.id}
            ...
            >
              ...
              <div className="details mt-2 p-3">
                ...
                <div className="platforms text-xs text-gray-400 mt-1">
                  {game.parent_platforms
                    ?.map((p) => p.platform.name)
                    .join(", ") || "Unknown Platforms"}
                </div>
                <div className="gameName mt-1 text-2xl font-bold">
                  {game.name}
                </div>
              </div>
            </div>
