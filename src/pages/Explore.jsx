...
const Explore = () => {
  ...
  return (
    <div className="sm:pt-40 pt-30 sm:px-6 px-4 flex flex-col">
      ...
      {/* 🎮 Games Section */}
      <div className="sm:ml-[22%] sm:w-[78%] min-h-screen overflow-y-auto p-6 border-1 border-[#4b4949] flex flex-wrap">
        {games.length > 0 ? (
          games.map((game) => (
            <div
              key={game.id}
            ...
            >
              ...
              <div className="details mt-2 p-3">
                <div className="flex justify-between text-sm">
                  <p className="cursor-pointer hover:text-blue-400" onClick={() => addToCart(game)}>
                    Add to cart +
                  </p>
                ...
                <div className="gameName mt-1 text-2xl font-bold cursor-pointer" onClick={() => navigate(`/game/${game.id}`)}>
                  {game.name}
                </div>
              </div>
            </div>
