...
const Explore = () => {
  ...
  return (
    <div className="sm:pt-40 pt-30 sm:px-6 px-4 flex">
      ...
      <div className="fixed top-25 left-6 h-[80vh] w-1/5 overflow-hidden hover:overflow-y-auto hide-scrollbar">
        <div className="category-1 flex flex-col gap-3">
          <h1 className="text-3xl font-bold text-white">Your Games</h1>
          <ul className="text-white flex flex-col gap-3 ">
            <li>
              <div className="flex items-center gap-3 ">
                <div className="bg-blue-400 h-7 w-7 p-1">
                  <svg
        ...
        <div className="category-2 flex flex-col gap-3 my-5">
          ...
          <ul className="text-white flex flex-col gap-3 ">
            <li>
              <div className="flex items-center gap-3 ">
                <div className="bg-[#202020]  h-7 w-7 p-1">
      ...
      {/* 🎮 Games Section */}
      <div className="ml-[22%] w-[78%] min-h-screen overflow-y-auto p-6 border-1 border-red-500 flex flex-wrap">
        {games.length > 0 ? (
          games.map((game) => (
            <div
              key={game.id}
